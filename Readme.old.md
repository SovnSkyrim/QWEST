...
This list, alongside [Aldrnari](https://github.com/SovnSkyrim/Aldrnari), is part of ``Sovn's Modding Legacy on Wabbajack``. This means it has originally been developed entirely by **[Sovn](https://github.com/SovnSkyrim)** but is not actively being developed by him. The list is now being maintained and actively developed by the ``QWEST! Dev Team``, that took over on the **17th of August 2021** which means the latest version  developed by Sovn is the ``3.7.1 - Maintenance Update 7``. More information on Sovn's departure can be found [here](https://www.patreon.com/posts/56166905), should Sovn ever return to active development, QWEST! will stay with its current team.
If you have any queries regarding the list, please ask them in the [Wabbajack Discord](https://discord.gg/wabbajack) or the [community server](https://discord.gg/alsanimonculory).
